...
//    }
//
//    public static HashMap<String, HashMap<String, ArrayList<String>>> getDeleteMessages() {
...
//            ResultSet rs = ps.executeQuery();
//            while (!rs.isClosed() && rs.next()) {
//                if (rs.getInt("instanceNr") < instanceNr && rs.getLong("deleteTime") < System.currentTimeMillis()) {
//                    String DiscordServerId = rs.getString("server");
//                    String DiscordChannelId = rs.getString("channel");
//                    String DiscordMessageId = rs.getString("id");
//
